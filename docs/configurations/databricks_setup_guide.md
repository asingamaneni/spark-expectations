...
3. Please follow the [Databricks Git integration guide](https://docs.databricks.com/en/repos/index.html) to integrate and clone the repo in Databricks
4. Please follow the [Microsoft Teams webhook documentation](https://learn.microsoft.com/en-us/microsoftteams/platform/webhooks-and-connectors/how-to/add-incoming-webhook) to create the webhook URL for your team-specific channel