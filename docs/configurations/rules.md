...
| Expect the minimum value in a column fall within a specified range | expect_column_min_to_be_between |accuracy  | ```min([col_name]) between [lower_bound] and [upper_bound]``` |
